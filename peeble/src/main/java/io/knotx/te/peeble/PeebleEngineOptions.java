...
public class PeebleEngineOptions {
  ...
  public PeebleEngineOptions() {
    init();
  }

  public PeebleEngineOptions(PeebleEngineOptions other) {
  ...
  public PeebleEngineOptions(JsonObject json) {
    init();
    PeebleEngineOptionsConverter.fromJson(json, this);
  }

  public JsonObject toJson() {
    JsonObject json = new JsonObject();
    PeebleEngineOptionsConverter.toJson(this, json);
    return json;
  }
   ...
   */
  public PeebleEngineOptions setCacheSize(Long cacheSize) {
   ...
   * @return a reference to this, so the API can be used fluently
   */
  public PeebleEngineOptions setCacheKeyAlgorithm(String cacheKeyAlgorithm) {
   ...
   * @return a reference to this, so the API can be used fluently
   */
  public PeebleEngineOptions setStartDelimiter(String startDelimiter) {
   ...
   * @return a reference to this, so the API can be used fluently
   */
  public PeebleEngineOptions setEndDelimiter(String endDelimiter) {
